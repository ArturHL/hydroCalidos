...
export function cargarDatosDeEjemplo() {
  ...
  const v1 = crearViaje({
    folio: 1,
    fechaObj: fechaEn(9),
    origen: 'Banco El Águila',
    material: 'Piedra',
    destino: '12+000',
    distanciaCapturada: 12,
    volumen: 15.4,
    placa: 'GXA-201',
  ...
  const v2 = crearViaje({
    folio: 2,
    fechaObj: fechaEn(8),
    origen: 'Banco La Cantera',
    material: 'Tepetate',
    destino: '18+300',
    distanciaCapturada: 22,
    volumen: 16.8,
    placa: 'HLB-114',
  ...
  const v4 = crearViaje({
    folio: 4,
    fechaObj: fechaEn(6),
    origen: 'Sitio de Tiro Norte',
    material: 'Desperdicio',
    destino: '25+750',
    distanciaCapturada: 21,
    volumen: 17.0,
    placa: 'MNP-772',
    operador: 'Ismael Cordero',
    checador: 'Fernando Ibarra',
  ...
  const v8 = crearViaje({
    folio: 8,
    fechaObj: fechaEn(1),
    origen: 'Patio de Prefabricados',
    material: 'Barrera tipo New Jersey',
    destino: '9+400',
    distanciaCapturada: 13,
    volumen: 12.5,
    placa: 'MNP-772',
    operador: 'Diego Salcido',
    checador: 'Fernando Ibarra',
